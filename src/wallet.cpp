...
// Poriun: total coins staked (non-spendable until maturity)
...
// Poriun: get current stake weight
...
// Poriun: check 'spent' consistency between wallet and txindex
// Poriun: fix wallet spent state according to txindex
...
// Poriun: disable transaction (only for coinstake)
